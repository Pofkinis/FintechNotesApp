    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete_note_activity:
                Intent deleteNoteActivity = new Intent(getApplicationContext(), com.example.third_assignment_template.DeleteNoteActivity.class);
                startActivity(deleteNoteActivity);
                return true;
            case R.id.all_notes:
